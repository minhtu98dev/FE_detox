...
const News = () => {
    ...
    try {
      ...
      setTimeout(async () => {
        const fetchedOrders = await fetch(
          `${backendUrl}/api/get/news/title/${search}`
        );
        const json = await fetchedOrders.json();
        console.log("fetchedOrders: ", json);
        setOrders(json);
  ...
  return (
    <div className="admin-product">
      ...
      <h3 className="mt-8">DANH SÁCH TIN TỨC</h3>
          ...
          {currentOrders.map((order, index) => (
            <tr key={order.id}>
              ...
              <td style={{ width: "140px" }}>
                ...
                <button className="bt-edit" onClick={() => editNews({ order })}>
        ...
        <>
          ...
          <div className="add_news">
            ...
            <div className="App container mx-auto p-4">
              <div className="App container mx-auto p-4">
                <h1 className="text-xl font-semibold mb-2">Ảnh bìa</h1>
                <input
                  type="file"
                  accept="image/*"
                  onChange={handleImageUpload}
                  className="block w-[250px] text-sm text-gray-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-blue-50 file:text-blue-700 hover:file:bg-blue-100"
                />
              </div>
              {imageSrc && (
          ...
          <h1 className="text-center mt-4 mb-4 text-xl font-bold">
            NỘI DUNG SẢN PHẨM
          </h1>
          <Editor
      ...
      {clickEdit && (
        <>
          ...
          <div className="add_news">
            <div className="container mx-auto p-4">
              <div className="title mb-4">
                <p className="text-lg font-semibold">Tiêu đề:</p>
          ...
          <h1 className="mb-5">NỘI DUNG SẢN PHẨM</h1>
          <Editor
            apiKey="dktrsjgv7t0oy38tkp29i0ijxq3pk9ted147urtwhky8n49u"
            onInit={(evt, editor) => (editorRef.current = editor)}
          ...
          <div className="mt-5">
            <button
              onClick={actionEdit}
              className="bg-black hover:bg-blue-700 text-white font-bold py-4 px-8 rounded"
            >
              Lưu
            </button>
          </div>
